%classificatore Gerarchico per trovare i pixel di una immagine che sono di pelle
clear all;
close all;
...
classifier = fitctree(train.values, train.labels);%allena il class
...
%con view(...) come dal pdf riesco a vedere l'albero
